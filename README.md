...
عند اختيار دقة **2048** يصنع المحرك الخامة على البطاقة بدقة 2K ثم يحفظ
`model.glb` بخامات **Ultra 4K PNG** بلا ضغط JPEG. جودة Roblox العالية تضيف
`model_UltraPlus_4K.glb` بشحذ أقوى ضمن حد Roblox البالغ 4K، بينما هدف Unreal
يضيف `model_UltraPlus_8K.glb` بخامة لون 8K وNormal بدقة 4K. تتم مرحلة التحسين
على المعالج بعد تحرير النموذج من الذاكرة الرسومية، ويفتح زر النتيجة ملف
Ultra+ تلقائيًا عند نجاح إنشائه.
...
- Ultra وUltra+ يحافظان على الخامة ويقللان آثار الضغط والبكسلة، لكنهما لا
  يستطيعان اختراع تفاصيل لم تكن موجودة أصلًا في الصورة أو في توليد SPAR3D.
