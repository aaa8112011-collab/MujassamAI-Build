...
للاستخدام الشخصي المحلي في الإمارات لا يلزم إدخال اسم مزوّد. استخدم مسار
البناء المحلي الموثق في `docs/HUNYUAN21-LOCAL-UAE.md`؛ فهو يسجل
`personal_local_only`، يمنع التوزيع أو تقديم المحرك لطرف ثالث، ويبقي مصدر
Tencent وناتج البناء على جهازك بدل GitHub Release أو Artifact.
